...
const AddMeeting = (props) => {
  ...
  const fetchAllData = async () => {
    setisLoading(true);
    try {
      const contactsResponse = await getApi("api/contact"); // Adjust the endpoint as necessary
      const leadsResponse = await getApi("api/lead"); // Adjust the endpoint as necessary

      setContactData(contactsResponse.data); // Assuming the response structure
      setLeadData(leadsResponse.data); // Assuming the response structure
    } catch (error) {
