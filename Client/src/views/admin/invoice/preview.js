                        ...
                        <tr key={index}>
                          ...
                          <td>{`${
                            item?.discountType === "percent"
                              ...
                              ? `${invoiceDetails?.currency}${item?.discount}`
                ...
                <div className="totals">
                  <table>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "start" }}>{`${
                        invoiceDetails?.currency
                      } ${invoiceDetails?.shippingTax || 0}`}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "start" }}>{`${
                        invoiceDetails?.currency
                      } ${invoiceDetails?.grandTotal || 0}`}</td>
                    </tr>
                  </table>
                </div>
