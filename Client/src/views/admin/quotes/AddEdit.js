            ...
            <Grid templateColumns="repeat(12, 1fr)" gap={3}>
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Select
                  ...
                  onChange={handleChange}
                  mb={
                    errors.quoteStage && touched.quoteStage ? undefined : "10px"
                  }
                  fontWeight="500"
              ...
              <GridItem colSpan={{ base: 12, md: 6 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors.billingCity && touched.billingCity ? "red.300" : null
                  }
                />
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
              ...
              <GridItem colSpan={{ base: 12, md: 10 }}>
                ...
                <Input
                  ...
                  fontWeight="500"
                  borderColor={
                    errors.shippingTax && touched.shippingTax ? "red.300" : null
                  }
                />
                <Text mb="10px" fontSize="sm" color={"red"}>
                  {" "}
