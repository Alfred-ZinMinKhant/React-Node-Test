        ...
        <div className="selectOpt">
          <Text>
            {cell?.row?.original?.invoiceConvertDate
              ? `${moment(cell?.row?.original?.invoiceConvertDate).format(
                  "DD-MM-YYYY HH:MM a"
                )}`
              : "-"}
          </Text>
            ...
            <Grid gap={4}>
              ...
              <GridItem colSpan={{ base: 2, md: 1 }}>
                ...
                {editableField === "title" ? (
                  ...
                  <Text
                    onDoubleClick={() =>
                      handleDoubleClick("title", data?.title, "Title")
                    }
                  >
              ...
              <GridItem colSpan={{ base: 2, md: 1 }}>
                ...
                {data?.oppotunity ? (
                  <Link
                    to={
                      opportunityAccess?.view &&
                      `/opportunitiesView/${data?.oppotunity}`
                    }
                  >
                    <Text
                      color={
                        opportunityAccess?.view ? "blue.500" : "blackAlpha.900"
                      }
                      sx={{
                        "&:hover": {
                          color: opportunityAccess?.view
                            ? "blue.500"
                            : "blackAlpha.900",
                          textDecoration: opportunityAccess?.view
                            ? "underline"
                            : "none",
                        },
                      }}
                ...
                {editableField === "validUntil" ? (
                  <>
                    <Input
                      ...
                      onChange={formik.handleChange}
                      onBlur={handleBlur}
                      value={dayjs(formik.values.validUntil).format(
                        "YYYY-MM-DD"
                      )}
                      borderColor={
              ...
              <GridItem colSpan={{ base: 2, md: 1 }}>
                ...
                {editableField === "terms" ? (
                  ...
                  <Text
                    onDoubleClick={() =>
                      handleDoubleClick("terms", data?.terms, "Terms")
                    }
                    style={{ width: "300px" }}
                  >
              ...
              <GridItem colSpan={{ base: 2, md: 1 }}>
                ...
                {data?.assignedTo ? (
                  ...
                  <Text
                    color={
                      user.role === "superAdmin" ? "blue.500" : "blackAlpha.900"
                    }
                    sx={{
                      "&:hover": {
                        color:
              ...
              <GridItem colSpan={{ base: 2, md: 1 }}>
                ...
                <Text>{`${data?.currency}${
                  data?.shippingTax ? data?.shippingTax : "0"
                }`}</Text>
              </GridItem>
              <GridItem colSpan={{ base: 2, md: 1 }}>
                <Text fontSize="sm" fontWeight="bold" color={"blackAlpha.900"}>
