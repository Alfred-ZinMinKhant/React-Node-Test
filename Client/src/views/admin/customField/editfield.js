              ...
              <Grid templateColumns="repeat(12, 1fr)" gap={3}>
                <GridItem colSpan={{ base: 12, sm: 6, md: 4 }}>
                  ...
                  <Input
                    ...
                    fontWeight="500"
                    borderColor={
                      errors.label && touched.label ? "red.300" : null
                    }
                  />
                ...
                >
                  ...
                  >
                    ...
                    <Flex>
                      ...
                      <Checkbox
                        isChecked={
                          values?.type === "range" || values.validate
                            ? true
                            : false
                        }
                        colorScheme="brandScheme"
                    ...
                    {!(
                      ...
                      <>
                        ...
                        <GridItem colSpan={{ base: 12, sm: 6, md: 4 }}>
                          ...
                          <Input
                            disabled={
                              values.validation[3].match === true ? false : true
                            }
                            fontSize="sm"
                            onChange={handleChange}
                            onBlur={handleBlur}
